...
<body>
	...
	<div class="my-container background-black text-white">
		...
		<div class="container">
			...
			<form action="boardGameCreate" method="post">
				<h3>Set board game's data</h3>
				<div class="form-group">
					...
					<div class="form-group">
						<label for="officialURL">Official page:</label> <input type="text"
							class="form-control" id="officialURL" name="officialURL" required>
					</div>
					<div class="form-group">
						<label for="rulesURL">Rules page:</label> <input type="text"
							class="form-control" id="rulesURL" name="rulesURL" required>
					</div>
					<div class="form-group">
					...
					<button type="submit" class="btn btn-primary">Create board game</button>
				</div>
