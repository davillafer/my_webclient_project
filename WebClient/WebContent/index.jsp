...
<body>
	...
	<div class="my-container background-black text-white">
		...
		%>
		<div class="container">
				<h1>Welcome to the board game project' page</h1>
		<p>In this page you can buy the games that we have available.
		You can request more games <a href="http://156.35.95.123:8060/">here.</a></p>
		</div>
