				...
				<div class="form-group">
					<div class="form-group">
						<label for="name">Name:</label> <input type="text"
							class="form-control" id="name" name="name" value="<%=boardGame.getName() %>" required disabled>
					</div>
					<div class="form-group">
						<label for="description">Description:</label> <input type="text"
							class="form-control" id="description" name="description" value="<%=boardGame.getDescription() %>" required disabled>
					</div>
					<div class="form-group">
						<label for="imageURL">Board Game cover:</label> <input type="text"
							class="form-control" id="imageURL" name="imageURL" value="<%=boardGame.getImageURL() %>" required disabled>
					</div>
					<div class="form-group">
						<label for="officialURL">Official page:</label> <input type="text"
							class="form-control" id="officialURL" name="officialURL" value="<%=boardGame.getOfficialURL() %>" required disabled>
					</div>
					<div class="form-group">
						<label for="rulesURL">Rules page:</label> <input type="text"
							class="form-control" id="rulesURL" name="rulesURL" value="<%=boardGame.getRulesURL() %>" required disabled>
					</div>
					<div class="form-group">
						<label for="price">Price (&#8364;):</label> <input type="number"
							class="form-control" id="price" name="price" value="<%=boardGame.getPrice() %>" required disabled>
					</div>
					<div class="form-group">
						<label for="stock">Stock:</label> <input type="number"
							class="form-control" id="stock" name="stock" value="<%=boardGame.getStock() %>" required disabled>
					</div>
				</div>
